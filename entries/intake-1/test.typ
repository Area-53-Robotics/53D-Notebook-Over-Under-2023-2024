...
To ensure that our intake was functioning at the level that we wanted, we tested the intake on two of the "Purposes of an Intake" that we identified in our #nb_entry_reference(date: datetime(year: 2023, month: 10, day: 14), type: "identify", title: "Intake"). The two that we chose to test are "Game Element Acquisition" and "Handling."
