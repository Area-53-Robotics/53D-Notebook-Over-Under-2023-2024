...
#tablex(
  ...
  cellx(align: center + horizon)[#image("./brainstorm/Catapult outtake.svg")],
  [
  ...
  cellx(align: center + horizon)[#image("./brainstorm/Puncher.svg")],
  [
  ...
  cellx(align: center + horizon)[#image("./brainstorm/flywheel outtake.svg")],
  [
