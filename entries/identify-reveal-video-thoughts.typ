...
#create_entry(
  ...
  [
    ...
    #nb_heading([Game Object], level: 1)
    ...
    #nb_heading([End-Game Elevation], level: 1)
    ...
    #nb_heading([Bot-Building], level: 1)
