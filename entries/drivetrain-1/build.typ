...
#grid(
  ...
  [
    ...
    Now that the new freshmen have an better idea of how to build a drive train, we wanted to start building the chassis for the left side. Building the chassis first is better because it help create the box structure for the wheels and gears.
  ...
  [
    ...
    Now that the drivetrain assembly is complete, our focus shifted to attaching the motors and troubleshooting potential issues during this meeting. Notably, we identified a challenge from uneven friction on either side of the drive train. This imbalance poses risks such as erratic movement and difficulties in maintaining a straight trajectory. Additionally, the observation that incorrect spacing for any of the axles can lead to the bending of the c-channel.
    ...
    Fortunately, we didn't ran into any major issues with our drive train which means this side of the drive train was a success. However, there was a small spacing error that we found towards the end of the meeting
