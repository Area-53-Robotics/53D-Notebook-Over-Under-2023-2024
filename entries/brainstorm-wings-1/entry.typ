...
#create_entry(
  ...
  [
    ...
    #tablex(
      ...
      cellx(align: center + horizon)[#image("Horizontally penumatic wings.svg")],
      [
      ...
      cellx(align: center + horizon)[#image("Motorized horizontal wings.svg")],
      [
      ...
      cellx(align: center + horizon)[#image("Motorized vertical expansion.svg")
      #image("Motorized vertical wings.svg")],
      [
