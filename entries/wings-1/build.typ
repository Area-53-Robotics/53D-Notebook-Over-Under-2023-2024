  ...
  [
    #gridx(
      ...
      [
        ...
        - Attached cainster perpendicular to the chassis
  ...
  [
    #gridx(
      ...
      [
        ...
        - Cutted a 3” x 10” long lexan sheet
        ...
        - #text(green)[Possible Solutions:]
          ...
          - Attmept to move the pneumatic piston further away from the pivot
      ],
    )
    #nb_admonition(type: "note")[
      The wings were still a bit inconsistent regardless of the solutions we tried. We will need to evaluate how much of a problem this will be in our Test phase, and apprpriately spend more time troubleshooting them in the future or rebuilding them.
    ]
  ],
)